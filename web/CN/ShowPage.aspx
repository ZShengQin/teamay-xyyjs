<%@ Page Language="C#" AutoEventWireup="True" Inherits="Teamay_CBST.CN.ShowPage"
...
<body>
    ...
    <div id="secondContentWrapper">
        <div id="secondContent">
            <div id="s_colsA">
                <h1><asp:Literal ID="LeftTitle" runat="server"></asp:Literal></h1>
                <div class="menus">
                    <ul>
                        <asp:Repeater ID="LeftMenu" runat="server">
                            <ItemTemplate>
                                <li class="level<%#Eval("zlevel") %> parent_<%#Eval("myParent") %>" id="s<%#Eval("id") %>">
                                    <a href="ShowPage.aspx?id=<%#Eval("id") %>" target="_self"><%#Eval("cn_name")%></a>
                                </li>
                            </ItemTemplate>
                        </asp:Repeater>
                    </ul>
            ...
            <div id="s_colsB">
                <div id="bar">
                    <h5>当前位置：首页 ><asp:Literal ID="DaoArticle" runat="server"></asp:Literal></h5>
                </div>
                <div id="trip">
                    <div id="innerContent">
                        <div id="ms"><asp:Literal ID="ContentFromDB" runat="server"></asp:Literal></div>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td height="28" align="center" valign="baseline">
                                                <span><img src="images/dot.gif" /></span>
                                            </td>
                                            ...
                                            <td height="28" align="center"><%#Eval("timenew") %></td>
                                        </tr>
                                        <tr>
                                            <td height="1" colspan="3" background="images/diana.jpg"></td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </table>
                        ...
                        <div id="singleNews" runat="server" visible="false">
                            ...
                            <h1 class="header"><asp:Literal ID="SingleTitle" runat="server"></asp:Literal></h1>
                            <h2 class="header" style="display:none">
                                发布日期：<asp:Literal ID="SingleDate" runat="server"></asp:Literal>
                                <asp:Literal ID="SingleTimes" runat="server" Visible="false"></asp:Literal>
                            </h2>
