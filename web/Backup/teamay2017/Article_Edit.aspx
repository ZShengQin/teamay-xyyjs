<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false"  Inherits="bgbx_Article_Edit" Codefile="Article_Edit.aspx.cs" %>
                ...
                <table border="0" cellpadding="5" cellspacing="0" >
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px; text-align: left; ">
                            ...
                            点击数 <asp:TextBox ID="ClickTimes" runat="server" CssClass="TextBox" Width="80px"></asp:TextBox>
                            <asp:RadioButtonList ID="RadioButtonList1"  Visible="false" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal">
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px; text-align: left; position:relative ">
                            ...
                            <div style=" position:absolute; right:20px; top :5px"><asp:Button ID="Button3" runat="server" Text="快速保存" CssClass="Button" OnClick="Button1_Click" ValidationGroup="aa"/></div>
                            </td>
                    </tr>
                    <tr>
                        <td style="text-align: right; height: 376px;" valign="top" colspan="3">

                            <textarea id="Editor1" cols="100" rows="8" style="width:700px;height:400px;" runat="server"></textarea>        </td>
        </tr>
                    <tr style="display:none">
                        <td valign="top" 
            ...
            <td colspan="3" style="text-align: left; padding-left: 20px; height: 35px;">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td style="width: 73px">
                <asp:Button ID="Button1" runat="server" Text="保存修改" CssClass="Button" OnClick="Button1_Click" ValidationGroup="aa"/></td>
