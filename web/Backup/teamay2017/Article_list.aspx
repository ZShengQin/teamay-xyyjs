<%@ Page Language="C#" AutoEventWireup="True" Inherits="bgbx_Article_list" Codebehind="Article_list.aspx.cs" %>
...
<body>
    ...
    <div>
        ...
        <tr><td colspan="3" align="center"><h3 style="font-size:15px; margin:4px auto; padding:0">
            <asp:Label ID="Label1" runat="server" Text="所有文章"></asp:Label></h3></td></tr>
            ...
            <td style="border-bottom: #cadcea 1px solid; height: 35px; text-align: left; padding-left: 20px;" colspan="3">
             <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                <tr>
                    ...
                    <td style="border-bottom: #cadcea 1px solid; height: 35px; text-align: left; font-weight:bold ">标题</td>
                    <td style="border-bottom: #cadcea 1px solid; height: 35px; text-align: left; font-weight:bold ">点击数</td>
                    <td style="border-bottom: #cadcea 1px solid; height: 35px; text-align: center; font-weight:bold " width="120px">添加时间</td>
                ...
                <ItemTemplate>
                            ...
                            <tr>
                                ...
                                <td style="border-bottom: #cadcea 1px solid; height: 35px; text-align: left;" >
                                    <%# Eval("cn_name")%></td>
                                    <td style="border-bottom: #cadcea 1px solid; height: 35px; text-align: left;" >
                                    <a href="Article_edit.aspx?id=<%# Eval("id") %>"><%# Eval("title") %></a></td>
                                    <td style="border-bottom: #cadcea 1px solid; height: 35px; text-align: left; " >
                                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("rq") %>'></asp:Label></td>
                                <td style="border-bottom: #cadcea 1px solid; height: 35px; text-align: center; " >
