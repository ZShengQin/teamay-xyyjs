<%@ Page Language="C#" AutoEventWireup="true" Inherits="PathConfig_New" Codebehind="PathConfig_New.aspx.cs" %>
                ...
                <table border="0" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        <td  align="right">
                            父类基准ID：</td>
                        <td style="padding-left: 10px; text-align: left" colspan="2">
                            <asp:Label ID="ParentID" runat="server" Text=""></asp:Label><asp:HiddenField ID="barID" runat="server"  />
                        </td>
                    </tr>
                    <tr>
                        <td  align="right">
                            父类基准顺序：</td>
                        <td style="padding-left: 10px; text-align: left" colspan="2">
                            <asp:Label ID="ParentSequence" runat="server" Text=""></asp:Label></td>
                    </tr>
                    <tr>
                        <td  align="right">
                            分类级别：</td>
                        <td style="padding-left: 10px; text-align: left;" colspan="2">
                            <asp:DropDownList ID="zlevel" runat="server" >
                    ...
                    <tr>
                        <td  align="right">
                            基准ID：</td>
                        <td style="padding-left: 10px; text-align: left" colspan="2">
                            <asp:TextBox ID="paixu" runat="server" CssClass="TextBox" Width="200px" ValidationGroup="aa"></asp:TextBox> 默认值为推荐值 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="paixu"
                                ErrorMessage="基准ID不能为空！" ValidationGroup="aa"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td  align="right">
                            基准排序：</td>
                        <td style="padding-left: 10px; text-align: left" colspan="2">
                            <asp:TextBox ID="sequence" runat="server" CssClass="TextBox" Width="200px" ValidationGroup="aa"></asp:TextBox> 默认值为推荐值 <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="sequence"
                                ErrorMessage="基准排序不能为空！" ValidationGroup="aa"></asp:RequiredFieldValidator></td>
                    </tr>
                    ...
                    <tr>
                        <td  align="right">
                            栏目类型：</td>
                        <td style="padding-left: 10px; text-align: left;" colspan="2">
                            <asp:DropDownList ID="ntype" runat="server" >
